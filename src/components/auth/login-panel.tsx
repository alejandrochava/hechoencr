...
export function LoginPanel({
  ...
  next: string;
  /** Solo se dibujan los proveedores que Supabase tiene encendidos. */
  ...
  return (
    <div className="space-y-5">
        ...
        <>
          <div className="grid gap-2">
            {providers.includes("github") ? (
              <>
                {/*
                  GitHub va en tinta y el correo en contorno, al reves de como
                  estaba. No es capricho: entrar con GitHub no manda ningun
                  correo, y ademas es lo unico que despues permite verificar
                  repos y reclamar proyectos al instante.
                */}
                <Button
                  variant="primary"
                  size="lg"
            ...
            {providers.includes("google") ? (
              <Button
                ...
                className={providers.includes("github") ? "mt-2 w-full" : "w-full"}
              >
      ...
      <form onSubmit={withEmail} className="space-y-3">
        ...
        <Button
          type="submit"
          // Si no hay ningun proveedor encendido, el correo es el unico
          // camino que queda y vuelve a ser el boton principal.
